...
plt.plot(perturbations, nscf, 'ro', label='bare response')
plt.plot(perturbations, scf, 'bo', label='interacting response')
...
plt.xlabel('α (eV)')
plt.ylabel('f electrons on first Eu site')
plt.legend()
# plt.show()
plt.savefig('Ucalc.png')

print(f'NSCF slope: {slope_nscf:.4f}')
print(f'SCF slope: {slope_scf:.4f}')
